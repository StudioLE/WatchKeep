// Most of this has been ripped straight from SpotCheck
// But I'm doing something it's not designed for
...
spotcheck.run = function(callback) {
  ...
  spotcheck.listFiles(listParams, function(paths){
    ...
    async.eachSeries(paths, spotcheck.processFile, function(err) {
      if (err) callback(err)
